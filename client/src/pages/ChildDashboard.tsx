...
const JUZ_DATA: JuzCard[] = [
  { num: 1,  arabic: "الم",              somaliName: "Juz Aliflaammiim",      englishName: "Alif Laam Miim",       surahStart: 1,  isOpen: true,  gradient: "from-pink-800 via-rose-700 to-red-800",              glowColor: "#f472b6" },
  { num: 2,  arabic: "سَيَقُولُ",         somaliName: "Juz Sayaqulu",          englishName: "Sayaqulu",             surahStart: 2,  isOpen: true,  gradient: "from-red-800 via-rose-700 to-orange-800",            glowColor: "#fb7185" },
  ...
  { num: 4,  arabic: "لَن تَنَالُوا",     somaliName: "Juz Lan Tanalu",        englishName: "Lan Tanalu",           surahStart: 4,  isOpen: true,  gradient: "from-yellow-700 via-lime-700 to-green-800",          glowColor: "#fbbf24" },
  { num: 5,  arabic: "وَٱلْمُحْصَنَٰتُ",  somaliName: "Juz Walmuhsanat",       englishName: "Wal-Muhsanat",         surahStart: 5,  isOpen: true,  gradient: "from-lime-800 via-green-700 to-emerald-800",         glowColor: "#86efac" },
  { num: 6,  arabic: "لَا يُحِبُّ ٱللَّهُ", somaliName: "Juz La Yuhibbullah",  englishName: "La Yuhibbullah",       surahStart: 6,  isOpen: true,  gradient: "from-emerald-800 via-teal-700 to-cyan-800",          glowColor: "#34d399" },
  { num: 7,  arabic: "وَإِذَا سَمِعُوا",  somaliName: "Juz Wa-iza Sami'u",     englishName: "Wa-iza Sami'u",        surahStart: 7,  isOpen: true,  gradient: "from-teal-800 via-cyan-700 to-sky-800",              glowColor: "#2dd4bf" },
  { num: 8,  arabic: "وَلَوْ أَنَّنَا",   somaliName: "Juz Walaw Annana",      englishName: "Walaw Annana",         surahStart: 8,  isOpen: true,  gradient: "from-cyan-800 via-sky-700 to-blue-800",              glowColor: "#22d3ee" },
  { num: 9,  arabic: "قَالَ ٱلْمَلَأُ",  somaliName: "Juz Qalal Mala",        englishName: "Qalal Mala",           surahStart: 9,  isOpen: true,  gradient: "from-sky-800 via-blue-700 to-indigo-800",            glowColor: "#60a5fa" },
  { num: 10, arabic: "وَاعْلَمُوٓا",      somaliName: "Juz Wa'lamu",           englishName: "Wa'lamu",              surahStart: 10, isOpen: true,  gradient: "from-blue-800 via-indigo-700 to-violet-800",         glowColor: "#818cf8" },
  { num: 11, arabic: "يَعْتَذِرُونَ",     somaliName: "Juz Ya'taziruna",       englishName: "Ya'taziruna",          surahStart: 11, isOpen: true,  gradient: "from-indigo-800 via-violet-700 to-purple-800",       glowColor: "#a78bfa" },
  { num: 12, arabic: "وَمَا مِن دَآبَّةٍ", somaliName: "Juz Wama min Dabbah",  englishName: "Wama min Dabbah",      surahStart: 12, isOpen: true,  gradient: "from-violet-800 via-purple-700 to-fuchsia-800",      glowColor: "#c084fc" },
  { num: 13, arabic: "وَمَآ أُبَرِّئُ",   somaliName: "Juz Wama Ubarri'u",     englishName: "Wama Ubarri'u",        surahStart: 13, isOpen: true,  gradient: "from-purple-800 via-fuchsia-700 to-pink-800",        glowColor: "#e879f9" },
  { num: 14, arabic: "رُّبَمَا",          somaliName: "Juz Rubama",            englishName: "Rubama",               surahStart: 15, isOpen: true,  gradient: "from-fuchsia-800 via-pink-700 to-rose-800",          glowColor: "#f0abfc" },
  { num: 15, arabic: "سُبْحَانَ ٱلَّذِى",  somaliName: "Juz Subhanal lazi",     englishName: "Subhanal-lazi",        surahStart: 17, isOpen: true,  gradient: "from-rose-800 via-red-700 to-orange-800",            glowColor: "#fda4af" },
  { num: 16, arabic: "قَالَ أَلَمْ",      somaliName: "Juz Qala Alam",         englishName: "Qala Alam",            surahStart: 18, isOpen: true,  gradient: "from-orange-700 via-amber-600 to-yellow-700",        glowColor: "#fdba74" },
  ...
  { num: 18, arabic: "قَدْ أَفْلَحَ",     somaliName: "Juz Qad Aflaha",        englishName: "Qad Aflaha",           surahStart: 23, isOpen: true,  gradient: "from-green-800 via-emerald-700 to-cyan-800",         glowColor: "#6ee7b7" },
  { num: 19, arabic: "وَقَالَ ٱلَّذِينَ", somaliName: "Juz Waqalal lazina",    englishName: "Waqalal-lazina",       surahStart: 25, isOpen: true,  gradient: "from-teal-800 via-blue-700 to-indigo-800",           glowColor: "#5eead4" },
