...
const JUZ_DATA: JuzCard[] = [
  { num: 1,  arabic: "الم",              somaliName: "Juz Aliflaammiim",      englishName: "Alif Laam Miim",       surahStart: 1,  isOpen: true,  gradient: "from-emerald-800 via-emerald-700 to-teal-700",       glowColor: "#34d399" },
  { num: 2,  arabic: "سَيَقُولُ",         somaliName: "Juz Sayaqulu",          englishName: "Sayaqulu",             surahStart: 2,  isOpen: true,  gradient: "from-cyan-800 via-cyan-700 to-sky-700",              glowColor: "#22d3ee" },
  { num: 3,  arabic: "تِلْكَ الرُّسُلُ",  somaliName: "Juz Tilkar Rusul",      englishName: "Tilkar Rusul",         surahStart: 3,  isOpen: true,  gradient: "from-blue-800 via-blue-700 to-indigo-700",           glowColor: "#60a5fa" },
  { num: 4,  arabic: "لَن تَنَالُوا",     somaliName: "Juz Lan Tanalu",        englishName: "Lan Tanalu",           surahStart: 4,  isOpen: true,  gradient: "from-violet-800 via-violet-700 to-purple-700",       glowColor: "#a78bfa" },
  { num: 5,  arabic: "وَٱلْمُحْصَنَٰتُ",  somaliName: "Juz Walmuhsanat",       englishName: "Wal-Muhsanat",         surahStart: 5,  isOpen: true,  gradient: "from-fuchsia-800 via-fuchsia-700 to-pink-700",       glowColor: "#e879f9" },
  { num: 6,  arabic: "لَا يُحِبُّ ٱللَّهُ", somaliName: "Juz La Yuhibbullah",  englishName: "La Yuhibbullah",       surahStart: 6,  isOpen: true,  gradient: "from-rose-800 via-rose-700 to-red-700",              glowColor: "#fb7185" },
  { num: 7,  arabic: "وَإِذَا سَمِعُوا",  somaliName: "Juz Wa-iza Sami'u",     englishName: "Wa-iza Sami'u",        surahStart: 7,  isOpen: true,  gradient: "from-orange-800 via-orange-700 to-amber-700",        glowColor: "#fb923c" },
  { num: 8,  arabic: "وَلَوْ أَنَّنَا",   somaliName: "Juz Walaw Annana",      englishName: "Walaw Annana",         surahStart: 8,  isOpen: true,  gradient: "from-yellow-700 via-yellow-600 to-lime-700",         glowColor: "#fbbf24" },
  { num: 9,  arabic: "قَالَ ٱلْمَلَأُ",  somaliName: "Juz Qalal Mala",        englishName: "Qalal Mala",           surahStart: 9,  isOpen: true,  gradient: "from-lime-800 via-lime-700 to-green-700",            glowColor: "#86efac" },
  { num: 10, arabic: "وَاعْلَمُوٓا",      somaliName: "Juz Wa'lamu",           englishName: "Wa'lamu",              surahStart: 10, isOpen: true,  gradient: "from-teal-800 via-teal-700 to-cyan-700",             glowColor: "#2dd4bf" },
  ...
  { num: 20, arabic: "أَمَّنْ خَلَقَ",    somaliName: "Juz Amman Khalaqa",     englishName: "Amman Khalaqa",        surahStart: 27, isOpen: false, gradient: "from-slate-700 via-slate-600 to-slate-700",          glowColor: "#94a3b8" },
  { num: 21, arabic: "أَمَّن يَتَسَآءَ",  somaliName: "Juz Amma Yatasaa",      englishName: "Amma Yatasaa",         surahStart: 29, isOpen: false, gradient: "from-slate-700 via-slate-600 to-slate-700",          glowColor: "#94a3b8" },
  { num: 22, arabic: "وَمَن يَقْنُتْ",    somaliName: "Juz Wa Man Yaqnut",     englishName: "Wa Man Yaqnut",        surahStart: 33, isOpen: false, gradient: "from-slate-700 via-slate-600 to-slate-700",          glowColor: "#94a3b8" },
  { num: 23, arabic: "وَمَآ أُبَرِّئُ",   somaliName: "Juz Wama Ubarri'u",     englishName: "Wama Ubarri'u",        surahStart: 36, isOpen: false, gradient: "from-slate-700 via-slate-600 to-slate-700",          glowColor: "#94a3b8" },
  { num: 24, arabic: "فَمَنْ أَظْلَمُ",   somaliName: "Juz Faman Azlamu",      englishName: "Faman Azlamu",         surahStart: 39, isOpen: false, gradient: "from-slate-700 via-slate-600 to-slate-700",          glowColor: "#94a3b8" },
  { num: 25, arabic: "إِلَيْهِ يُرَدُّ",  somaliName: "Juz Ilayhi Yuraddu",    englishName: "Ilayhi Yuraddu",       surahStart: 41, isOpen: false, gradient: "from-slate-700 via-slate-600 to-slate-700",          glowColor: "#94a3b8" },
  { num: 26, arabic: "حٰمٓ",              somaliName: "Juz Ha Miim",           englishName: "Ha Mim",               surahStart: 46, isOpen: false, gradient: "from-slate-700 via-slate-600 to-slate-700",          glowColor: "#94a3b8" },
  { num: 27, arabic: "قَالَ فَمَا خَطْبُكُمْ", somaliName: "Juz Qala Fama", englishName: "Qala Fama",            surahStart: 51, isOpen: false, gradient: "from-slate-700 via-slate-600 to-slate-700",          glowColor: "#94a3b8" },
  { num: 28, arabic: "قَدْ سَمِعَ ٱللَّهُ", somaliName: "Juz Qad Sami'a",     englishName: "Qad Sami'a",           surahStart: 58, isOpen: false, gradient: "from-slate-700 via-slate-600 to-slate-700",          glowColor: "#94a3b8" },
  { num: 29, arabic: "تَبَارَكَ",         somaliName: "Juz Tabaraka",          englishName: "Tabaraka",             surahStart: 67, isOpen: false, gradient: "from-slate-700 via-slate-600 to-slate-700",          glowColor: "#94a3b8" },
